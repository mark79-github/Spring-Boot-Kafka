...
public class RecipientModel {
    ...
    public RecipientModel(
            @JsonProperty(value = KafkaMessageJsonFieldConstants.DISPLAY_NAME, access = JsonProperty.Access.READ_WRITE)
                    String displayName,
            @JsonProperty(value = KafkaMessageJsonFieldConstants.EMAIL, required = true, access = JsonProperty.Access.READ_WRITE)
                    String email) {
