...
public class KafkaMessageModel {
  ...
  @Pattern(
      regexp = AppConstants.TENANT_ID_REGEX,
      message = KafkaErrorMessages.TENANT_ID_IS_NOT_VALID)
  ...
  @NotNull(message = KafkaErrorMessages.PROCESSOR_DISPLAY_NAME_IS_REQUIRED)
  //  TODO Not working when is processorDisplayName is set to null
  ...
  KafkaMessageModel(
      @JsonProperty(
              value = KafkaMessageJsonFieldConstants.TASK,
              required = true,
              access = JsonProperty.Access.READ_WRITE)
          JsonNode task,
      @JsonProperty(
              value = KafkaMessageJsonFieldConstants.EVENT_TYPE,
              required = true,
              access = JsonProperty.Access.READ_WRITE)
          EventType eventType,
      @JsonProperty(
              value = KafkaMessageJsonFieldConstants.TASK_MODEL_TYPE,
              required = true,
              access = JsonProperty.Access.READ_WRITE)
          TaskModelType taskModelType,
      @JsonProperty(
              value = KafkaMessageJsonFieldConstants.TENANT_ID,
              required = true,
              access = JsonProperty.Access.READ_WRITE)
          String tenantId,
      @JsonProperty(
              value = KafkaMessageJsonFieldConstants.TENANT_URL,
              required = true,
              access = JsonProperty.Access.READ_WRITE)
          String tenantUrl,
      @JsonProperty(
              value = KafkaMessageJsonFieldConstants.PROCESSOR_EMAIL,
              required = true,
              access = JsonProperty.Access.READ_WRITE)
          String processorEmail,
      @JsonProperty(
              value = KafkaMessageJsonFieldConstants.PROCESSOR_DISPLAY_NAME,
              access = JsonProperty.Access.READ_WRITE)
          String processorDisplayName,
      @JsonProperty(
              value = KafkaMessageJsonFieldConstants.RECIPIENTS_EMAIL,
              required = true,
              access = JsonProperty.Access.READ_WRITE)
